...
?>
<script type="text/javascript" language="JavaScript" src="http://127.0.0.1/ibge/assets/js/inc/js_tela_inc.js"></script>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#modal").modal('hide');
                    ...
                    $("#erro").modal('');
                    $("#erroTexto").html("<h2>Erro ao cadastrar o bairro.</h2>");
                    $("#erro").modal('show');
                }
